...
def call_defend_api(waf_name: str, payloads: list, attack_type:str, existing_rules: list[str] = None) -> dict:
    request_data = {
        "waf_name": waf_name,
        "payloads": payloads,
...
def main():
    ...
    for waf in WAF_DVWA_URLS:
        ...
        result = call_defend_api(waf_name=waf, payloads=payload_results, existing_rules=existing_rules, attack_type=attack_type)
