...
=======
  ...
  const [numOfPayloads, setNumOfPayloads] = useState(5);
        ...
        {activeTab === 'Attack' && (
          <>
            ...
            <form className="flex items-center space-x-4 mb-4" onSubmit={async (e) => {
              ...
              try {
                const res = await Services.attack(domain, attackType, numOfPayloads);
              ...
              >
                ...
                <option value="XSS DOM">XSS DOM</option>
              ...
              <div className="flex items-center space-x-2">
                <label htmlFor="numOfPayloads" className="text-sm font-medium text-gray-700">Số lượng payloads</label>
                <input
                  id="numOfPayloads"
                  type="number"
                  min={1}
                  max={50}
                  className="border rounded px-3 py-2 w-20 text-center focus:ring-2 focus:ring-blue-400"
                  value={numOfPayloads}
                  onChange={e => setNumOfPayloads(Number(e.target.value))}
                />
              </div>
              <button
                type="submit"
